...
def main(unused_argv):
    ...
    mnist_classifier = tf.estimator.Estimator(
        model_fn=cnn_model_fn, model_dir="/tmp/mnist_trial")
    ...
    for i in range(3):
        ...
        print ('\n')
        l2 = mnist_classifier.get_variable_names()
        step2 = mnist_classifier.get_variable_value("global_step")
        print("ls :", l2 ,'\n')
        print ("global step:", step2, '\n')
        loss_results = mnist_classifier.evaluate(input_fn = test_eval_fn)
        eval_results = mnist_classifier.evaluate(input_fn=eval_input_fn)  
        print('eval results:', eval_results, '\n')
        print('eval loss ', loss_results["loss"])
        print('********','\n')
